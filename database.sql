...
CREATE TABLE `exam_rooms` (
  ...
  `ex_session` varchar(5) DEFAULT NULL,
  `room_num` varchar(10) DEFAULT NULL,
  `invigilator_id` varchar(10) DEFAULT NULL,
...
INSERT INTO `exam_rooms` (`course_code`, `ex_date`, `session`, `exam_type`, `ex_session`, `room_num`, `invigilator_id`, `no_of_students`) VALUES
('CE201', '2023-05-04', 'FN', NULL, '18B', 'Room 1', 'Faculty 1', 25),
('CE201', '2023-05-04', 'FN', NULL, '18B', 'Room 2', 'Faculty 2', 12),
('Cs201', '2023-05-08', 'FN', NULL, '18B', 'Room 1', 'Faculty 1', 25),
('CS202', '2023-05-11', 'FN', NULL, '18B', 'Room 1', 'Faculty 1', 25),
('CE201', '2023-05-04', NULL, NULL, '18B', 'CE_room1', '01CE01', NULL),
('CE201', '2023-05-04', NULL, NULL, '18B', 'CE_room2', '01IT01', NULL),
('CE201', '2023-05-04', NULL, NULL, '18B', 'CE_room1', '01CE01', 25),
('CE201', '2023-05-04', NULL, NULL, '18B', 'CE_room2', '01IT01', 25),
('CS201', '2023-05-08', NULL, NULL, '18B', 'CE_room1', '01CE01', 0),
('CS202', '2023-05-11', NULL, NULL, '18B', 'CE_room1', '01CE01', 0),
('EE201', '2023-05-15', NULL, NULL, '18B', 'CE_room1', '01CE01', 0),
('EE202', '2023-05-19', NULL, NULL, '18B', 'CE_room1', '01CE01', 0),
('MA201', '2023-05-22', NULL, NULL, '18B', 'CE_room1', '01CE01', 0),
('ME202', '2023-05-25', NULL, NULL, '18B', 'CE_room1', '01CE01', 0);
...
('CE201', '0000-00-00', 'FN', 'R', '18B'),
('CS201', '2023-05-08', 'FN', 'R', '18B'),
('CS202', '2023-05-11', 'FN', 'R', '18B'),
('EE201', '2023-05-15', 'FN', 'R', '18B'),
('EE202', '2023-05-19', 'FN', 'R', '18B'),
('MA201', '2023-05-22', 'FN', 'R', '18B'),
('ME202', '2023-05-25', 'FN', 'R', '18B');
...
('18CE1002', '18B', 98, NULL, 1),
('18CE1004', '18B', 96, NULL, 1),
('18CE1005', '18B', 98, NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `u_exam_result`
--

CREATE TABLE `u_exam_result` (
  `REGNO` varchar(10) NOT NULL,
  `SEM` int(11) NOT NULL,
  `COURSE_CODE` varchar(10) NOT NULL,
...
--
-- Dumping data for table `u_exam_result`
--

INSERT INTO `u_exam_result` (`REGNO`, `SEM`, `COURSE_CODE`, `PRGM_ID`, `RESULT`) VALUES
('20IT1031', 3, 'ITH01', 8, 'S'),
('20IT1031', 4, 'ITH02', 8, 'A'),
('20IT1031', 5, 'ITH03', 8, 'F'),
('20IT1031', 6, 'ITH04', 8, 'D'),
('20IT1031', 1, 'FY201', 8, 'P'),
('20IT1031', 1, 'MA201', 8, 'B'),
('20IT1031', 1, 'PH201', 8, 'A'),
('20IT1031', 1, 'CY201', 8, 'C'),
('20IT1031', 1, 'HS201', 8, 'A'),
('20IT1031', 1, 'ME201', 8, 'A'),
('20IT1031', 1, 'PH202', 8, 'S'),
('20IT1031', 1, 'CY202', 8, 'E'),
('20IT1031', 2, 'MA202', 8, 'F'),
('20IT1031', 2, 'CE201', 8, 'C'),
('20IT1031', 2, 'CS201', 8, 'D'),
('20IT1031', 2, 'ME202', 8, 'A'),
('20IT1031', 2, 'CE201', 8, 'C'),
('20IT1031', 2, 'EE202', 8, 'A'),
('20IT1031', 2, 'CS202', 8, 'F'),
('20IT1031', 3, 'EC233', 8, 'A'),
('20IT1031', 3, 'IT201', 8, 'B'),
('20IT1031', 3, 'IT202', 8, 'C'),
('20IT1031', 3, 'IT203', 8, 'D'),
('20IT1031', 3, 'SH201', 8, 'S'),
('20IT1031', 3, 'IT204', 8, 'S'),
('20IT1031', 3, 'IT205', 8, 'F'),
('20IT1031', 3, 'IT206', 8, 'A'),
('20IT1031', 3, 'SH202', 8, 'P'),
('20IT1031', 4, 'MA206', 8, 'A'),
('20IT1031', 4, 'IT207', 8, 'B'),
('20IT1031', 4, 'IT208', 8, 'B'),
('20IT1031', 4, 'IT209', 8, 'D'),
('20IT1031', 4, 'IT210', 8, 'D'),
('20IT1031', 4, 'IT211', 8, 'D'),
('20IT1031', 4, 'IT212', 8, 'C'),
('20IT1031', 4, 'IT213', 8, 'A'),
('20IT1031', 5, 'IT214', 8, 'F'),
('20IT1031', 5, 'IT215', 8, 'F'),
('20IT1031', 5, 'IT216', 8, 'A'),
('20IT1031', 5, 'IT217', 8, 'B'),
('20IT1031', 5, 'ITY02', 8, 'B'),
('20IT1031', 5, 'IT218', 8, 'B'),
('20IT1031', 5, 'IT219', 8, 'F'),
('20IT1031', 5, 'IT220', 8, 'B'),
('20IT1031', 5, 'SH203', 8, 'P'),
('20IT1031', 5, 'MEO06', 8, 'B'),
('20IT1062', 1, 'FY201', 0, 'P'),
('20IT1062', 1, 'MA201', 0, 'B'),
('20IT1062', 1, 'PH201', 0, 'A'),
('20IT1062', 1, 'CY201', 0, 'C'),
('20IT1062', 1, 'HS201', 0, 'A'),
('20IT1062', 1, 'ME201', 0, 'A'),
('20IT1062', 1, 'PH202', 0, 'S'),
('20IT1062', 1, 'CY202', 0, 'E'),
('20IT1062', 2, 'MA202', 0, 'F'),
('20IT1062', 2, 'CE201', 0, 'C'),
('20IT1062', 2, 'CS201', 0, 'D'),
('20IT1062', 2, 'ME202', 0, 'A'),
('20IT1062', 2, 'CE201', 0, 'C'),
('20IT1062', 2, 'EE202', 0, 'A'),
('20IT1062', 2, 'CS202', 0, 'F'),
('20IT1062', 3, 'EC233', 0, 'A'),
('20IT1062', 3, 'IT201', 0, 'B'),
('20IT1062', 3, 'IT202', 0, 'C'),
('20IT1062', 3, 'IT203', 0, 'D'),
('20IT1062', 3, 'SH201', 0, 'S'),
('20IT1062', 3, 'IT204', 0, 'S'),
('20IT1062', 3, 'IT205', 0, 'F'),
('20IT1062', 3, 'IT206', 0, 'A'),
('20IT1062', 3, 'SH202', 0, 'P'),
('20IT1062', 4, 'MA206', 0, 'A'),
('20IT1062', 4, 'IT207', 0, 'B'),
('20IT1062', 4, 'IT208', 0, 'B'),
('20IT1062', 4, 'IT209', 0, 'D'),
('20IT1062', 4, 'IT210', 0, 'D'),
('20IT1062', 4, 'IT211', 0, 'D'),
('20IT1062', 4, 'IT212', 0, 'C'),
('20IT1062', 4, 'IT213', 0, 'A'),
('20IT1062', 5, 'IT214', 0, 'F'),
('20IT1062', 5, 'IT215', 0, 'F'),
('20IT1062', 5, 'IT216', 0, 'A'),
('20IT1062', 5, 'IT217', 0, 'B'),
('20IT1062', 5, 'ITY02', 0, 'B'),
('20IT1062', 5, 'IT218', 0, 'B'),
('20IT1062', 5, 'IT219', 0, 'F'),
('20IT1062', 5, 'IT220', 0, 'B'),
('20IT1062', 5, 'SH203', 0, 'P'),
('20IT1062', 5, 'MEO06', 0, 'B'),
('20IT1002', 3, 'ITH01', 0, 'S'),
('20IT1002', 4, 'ITH02', 0, 'A'),
('20IT1002', 5, 'ITH03', 0, 'F'),
('20IT1002', 6, 'ITH04', 0, 'D'),
('20IT1002', 1, 'FY201', 0, 'P'),
('20IT1002', 1, 'MA201', 0, 'B'),
('20IT1002', 1, 'PH201', 0, 'A'),
('20IT1002', 1, 'CY201', 0, 'C'),
('20IT1002', 1, 'HS201', 0, 'A'),
('20IT1002', 1, 'ME201', 0, 'A'),
('20IT1002', 1, 'PH202', 0, 'S'),
('20IT1002', 1, 'CY202', 0, 'E'),
('20IT1002', 2, 'MA202', 0, 'F'),
('20IT1002', 2, 'CE201', 0, 'C'),
('20IT1002', 2, 'CS201', 0, 'D'),
('20IT1002', 2, 'ME202', 0, 'A'),
('20IT1002', 2, 'CE201', 0, 'C'),
('20IT1002', 2, 'EE202', 0, 'A'),
('20IT1002', 2, 'CS202', 0, 'F'),
('20IT1002', 3, 'EC233', 0, 'A'),
('20IT1002', 3, 'IT201', 0, 'B'),
('20IT1002', 3, 'IT202', 0, 'C'),
('20IT1002', 3, 'IT203', 0, 'D'),
('20IT1002', 3, 'SH201', 0, 'S'),
('20IT1002', 3, 'IT204', 0, 'S'),
('20IT1002', 3, 'IT205', 0, 'F'),
('20IT1002', 3, 'IT206', 0, 'A'),
('20IT1002', 3, 'SH202', 0, 'P'),
('20IT1002', 4, 'MA206', 0, 'A'),
('20IT1002', 4, 'IT207', 0, 'B'),
('20IT1002', 4, 'IT208', 0, 'B'),
('20IT1002', 4, 'IT209', 0, 'D'),
('20IT1002', 4, 'IT210', 0, 'D'),
('20IT1002', 4, 'IT211', 0, 'D'),
('20IT1002', 4, 'IT212', 0, 'C'),
('20IT1002', 4, 'IT213', 0, 'A'),
('20IT1002', 5, 'IT214', 0, 'F'),
('20IT1002', 5, 'IT215', 0, 'F'),
('20IT1002', 5, 'IT216', 0, 'A'),
('20IT1002', 5, 'IT217', 0, 'B'),
('20IT1002', 5, 'ITY02', 0, 'B'),
('20IT1002', 5, 'IT218', 0, 'B'),
('20IT1002', 5, 'IT219', 0, 'F'),
('20IT1002', 5, 'IT220', 0, 'B'),
('20IT1002', 5, 'SH203', 0, 'P'),
('20IT1002', 5, 'MEO06', 0, 'B');
...
INSERT INTO `u_external_marks` (`REGNO`, `COURSE_CODE`, `EXTERNAL_MARKS`, `GRADE`, `GRADEPT`, `SESSION`) VALUES
('18CE1004', 'CE201', 59.0, 'S', 10, '18B'),
('18CE1004', 'CS201', 59.0, 'S', 10, '18B'),
('18CE1004', 'CS202', 59.0, 'S', 10, '18B'),
('18CE1004', 'EE201', 59.0, 'S', 10, '18B'),
('18CE1004', 'EE202', 59.0, 'S', 10, '18B'),
('18CE1004', 'MA201', 59.0, 'S', 10, '18B'),
('18CE1004', 'ME202', 45.0, 'A', 9, '18B'),
('18CE1005', 'CE201', 60.0, 'S', 10, '18B'),
('18CE1005', 'CS201', 60.0, 'S', 10, '18B'),
('18CE1005', 'CS202', 60.0, 'S', 10, '18B'),
('18CE1005', 'EE201', 60.0, 'S', 10, '18B'),
('18CE1005', 'EE202', 60.0, 'S', 10, '18B'),
('18CE1005', 'MA201', 60.0, 'S', 10, '18B'),
('18CE1005', 'ME202', 46.0, 'A', 9, '18B');
...
('01CE01', '12345', 'Priyanka', 'CE', 'Associate Professor', 'priyanka@pec.edu'),
('01IT01', '9443206299', 'KANMANI S', 'CE', 'PROFESSOR', 'kanmani@ptuniv.edu.in'),
('01IT02', '9442086394', 'EZHILARASAN M', 'CE', 'PROFESSOR', 'mrezhil@ptuniv.edu.in'),
('01IT03', '9443535915', 'SARASWATHI S', 'CE', 'PROFESSOR', 's.saraswathi@ptuniv.edu.in'),
('01IT04', '9443616935', 'SANTHI BASKARAN', 'CE', 'PROFESSOR', 'santhibaskaran@ptuniv.edu.in'),
('01IT05', '9488821647', 'GOVINDASAMY V', 'CE', 'ASSOCIATE PROFESSOR', 'vgopu@ptuniv.edu.in'),
('01IT06', '9443790916', 'GEETHA V', 'CE', 'ASSOCIATE PROFESSOR', 'geetha@pec.edu'),
('01IT07', '9443287682', 'BOOBALAN P', 'CE', 'ASSOCIATE PROFESSOR', 'boobalanp@ptuniv.edu.in'),
('01IT08', '9443291154', 'SHANTHI G', 'CE', 'ASSISTANT PROFESSOR', 'shanthikarthikeyan@ptuniv.edu.in'),
('01IT09', '9443630711', 'ANBARASI M S', 'CE', 'ASSISTANT PROFESSOR', 'anbarasims@ptuniv.edu.in'),
('01IT10', '9789065502', 'MARAGATHAVALLI P', 'CE', 'ASSISTANT PROFESSOR', 'marapriya@ptuniv.edu.in'),
('1', 'vysh', 'GNANALAKSHMI', 'CE', 'Professor', 'vysh@pec.edu'),
('2', 'vikram', 'SARAVANAN', 'CE', 'Professor', 'vikram@pec.edu');
...
--
-- Table structure for table `u_hm`
--

CREATE TABLE `u_hm` (
  `REGNO` varchar(8) NOT NULL,
  `H_OR_M` varchar(5) NOT NULL,
  `DEPT_ID` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `u_hm`
--

INSERT INTO `u_hm` (`REGNO`, `H_OR_M`, `DEPT_ID`) VALUES
('20IT1031', 'HONOR', 'IT'),
('20IT1002', 'MINOR', 'EE');
...
--
-- Table structure for table `u_hm_allotment`
--

CREATE TABLE `u_hm_allotment` (
  `regno` varchar(10) NOT NULL,
  `alloted_prgm` float(2,0) NOT NULL,
...
--
-- Table structure for table `u_nptel_completion`
--

CREATE TABLE `u_nptel_completion` (
  `REGNO` varchar(8) NOT NULL,
  `COURSE_NAME` varchar(50) NOT NULL,
  `SCORE` varchar(5) NOT NULL,
  `RESULT` varchar(15) NOT NULL,
  `EXAM_SESSION` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `u_nptel_completion`
--

INSERT INTO `u_nptel_completion` (`REGNO`, `COURSE_NAME`, `SCORE`, `RESULT`, `EXAM_SESSION`) VALUES
('20IT1031', 'ETHICAL HACKING', '53', 'PASS', '2022-APRIL');

-- --------------------------------------------------------

--
-- Table structure for table `u_oec_allotment`
--

CREATE TABLE `u_oec_allotment` (
  `regno` varchar(10) NOT NULL,
  `course_code` varchar(10) NOT NULL,
  `session` varchar(5) NOT NULL,
...
--
-- Dumping data for table `u_oec_allotment`
--

INSERT INTO `u_oec_allotment` (`regno`, `course_code`, `session`, `allotment_date`) VALUES
('18CE1002', 'CSO01', '23A', '2023-04-02 17:09:53'),
('18CE1008', 'CSO01', '23A', '2023-04-02 17:36:50');
...
INSERT INTO `u_prgm` (`PRGM_ID`, `DEPT_ID`, `PRGM_NAME`, `offered`) VALUES
(1, 'CE', 'Bachelor of Technology', 1),
(2, 'ME', 'Bachelor of Technology', 1),
(3, 'EC', 'Bachelor of Technology', 1),
(4, 'CS', 'Bachelor of Technology', 1),
(5, 'EE', 'Bachelor of Technology', 1),
(6, 'EI', 'Bachelor of Technology', 1),
(7, 'CH', 'Bachelor of Technology', 1),
(8, 'IT', 'Bachelor of Technology', 1),
(9, 'MT', 'Bachelor of Technology', 1),
(10, 'CE', 'Master of Technology - Structural Engineering', 1),
(11, 'CE', 'Master of Technology - Environmental Engineering ', 1),
(12, 'ME', 'Master of Technology - Energy Technology', 1),
(13, 'ME', 'Master of Technology - Production Design and Manufacturing', 1),
(14, 'EC', 'Master of Technology - Electronics and Communication Engineering ', 1),
(15, 'EC', 'Master of Technology - Wireless Communication', 1),
(16, 'CS', 'Master of Technology - Data Science', 1),
(17, 'CS', 'Master of Technology - Information Security', 1),
(18, 'EE', 'Master of Technology - Electrical Drives and Control', 1),
(19, 'IT', 'Master of Technology - Internet of Things ', 1),
(20, 'EI', 'Master of Technology - Instrumentation Engineering ', 1),
(21, 'CS', 'Master of Computer Application ', 1),
(22, 'PH', 'Master of Science - Materials Science and Technology', 1),
(23, 'MB', 'Master of Business Administration - Innovation, Entrepreneurship and Venture Development ', 1),
(24, 'MB', 'Master of Business Administration - International Business ', 1),
(25, 'IT', 'Honors', 1),
(26, 'CS', 'Honors', 1),
(27, 'CE', 'Honors', 1),
(28, 'ME', 'Honors', 1),
...
CREATE TABLE `u_prgm_elective_course` (
  ...
  `COURSE_CODE` varchar(10) NOT NULL,
  `SEM` int(11) DEFAULT NULL,
  `NO_OF_STUDENTS_ENROLLED` float DEFAULT 0,
...
(NULL, 'CEO01', NULL, 0, 2, '22A', '1'),
(NULL, 'CSO01', NULL, 0, 2, '22A', '1'),
(NULL, 'CSO01', NULL, 2, 2, '23A', '1'),
(NULL, 'ECO01', NULL, 0, 2, '22A', '1'),
(NULL, 'ECO02', NULL, 0, 2, '22A', '1'),
(NULL, 'EEO01', NULL, 0, 2, '22A', '1'),
(NULL, 'ITO01', NULL, 0, 2, '22A', '1'),
(NULL, 'ITO01', NULL, 0, 2, '23A', '1'),
(NULL, 'ITO02', NULL, 0, 2, '22A', '1'),
(NULL, 'MEO01', NULL, 0, 2, '22A', '1'),
(NULL, 'MEO01', NULL, 0, 2, '23A', '1');

-- --------------------------------------------------------

--
-- Table structure for table `u_registration_track`
--
...
('18CE1001', 'ABISHEK P', 'M', '02-03-2001', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1002', 'ADFAR MAQBOOL', 'M', '05-04-2000', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1003', 'ANUKEERTHANA S', 'F', '23-08-2000', NULL, NULL, 8, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1004', 'ARAVIND D', 'M', '25-09-2000', NULL, NULL, 1, 5, NULL, NULL, 'sridhala.js@pec.edu', NULL, '975866717579', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1005', 'ARAVIND R', 'M', '17-07-2001', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1006', 'ARSALAN YAQOOB ', 'M', '07-04-2001', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1008', 'BERMIN BINI', 'M', '23-05-2000', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1009', 'DEVAR S', 'M', '03-01-2001', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1010', 'DIVIYA N', 'F', '22-10-2000', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1011', 'DIVYA.R', 'F', '23-09-2000', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1012', 'DIVYABHARATHY S', 'F', '25-06-2001', NULL, NULL, 8, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1013', 'ELAKKIYA S', 'F', '06-09-1999', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1014', 'GANESH M', 'M', '29-10-2000', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1015', 'M.GOKUL PRAKASH ', 'M', '03-08-2001', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('18CE1016', 'GUNALAN K', 'M', '22-04-2001', NULL, NULL, 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('20IT1031', 'MAATHUL MAANAS', 'M', '21-05-2002', 2020, NULL, 8, NULL, NULL, NULL, 'maanas@pec.edu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('20IT1055', 'SRIDHALA J S', 'F', NULL, NULL, NULL, 8, 6, 0, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Indexes for table `u_hm_allotment`
--
ALTER TABLE `u_hm_allotment`
  ADD PRIMARY KEY (`regno`,`alloted_prgm`),
  ADD KEY `alloted_prgm` (`alloted_prgm`);
...
--
-- Indexes for table `u_oec_allotment`
--
ALTER TABLE `u_oec_allotment`
  ADD PRIMARY KEY (`regno`,`course_code`,`session`),
...
ALTER TABLE `u_prgm_elective_course`
  ADD PRIMARY KEY (`COURSE_CODE`,`SESSION`),
...
--
-- Indexes for table `u_registration_track`
--
ALTER TABLE `u_registration_track`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `u_registration_track`
--
ALTER TABLE `u_registration_track`
...
--
-- Constraints for table `u_hm_allotment`
--
ALTER TABLE `u_hm_allotment`
  ADD CONSTRAINT `u_hm_allotment_ibfk_1` FOREIGN KEY (`alloted_prgm`) REFERENCES `u_prgm` (`PRGM_ID`),
  ADD CONSTRAINT `u_hm_allotment_ibfk_2` FOREIGN KEY (`regno`) REFERENCES `u_student` (`REGNO`);
...
--
-- Constraints for table `u_oec_allotment`
--
ALTER TABLE `u_oec_allotment`
  ADD CONSTRAINT `u_oec_allotment_ibfk_1` FOREIGN KEY (`regno`) REFERENCES `u_student` (`REGNO`),
  ADD CONSTRAINT `u_oec_allotment_ibfk_2` FOREIGN KEY (`course_code`) REFERENCES `u_course` (`COURSE_CODE`);
